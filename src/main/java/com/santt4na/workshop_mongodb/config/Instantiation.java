package com.santt4na.workshop_mongodb.config;
...
import com.santt4na.workshop_mongodb.dto.AuthorDTO;
import com.santt4na.workshop_mongodb.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
   ...
   public void run(String... args) throws Exception {
      ...
      Post post1 = new Post(null, sdf.parse("21/03/2024"), "Partiu viagem", "Vou viajar para São Paulo,Abraços!",
            new AuthorDTO(maria));
      Post post2 = new Post(null, sdf.parse("20/07/2024"), "Bom dia", "Acordei feliz hoje !", new AuthorDTO(maria));
